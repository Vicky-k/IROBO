package com.example.vikas.fifth;
            ...
            try {
                ...
                while (true) {
                    ...
                    MainActivity.this.runOnUiThread(new Runnable() {
                        ...
                        @Override
                        public void run() {
                            Toast.makeText(getApplicationContext(), clientData.toString(),Toast.LENGTH_SHORT).show();
                            speaker.speak(clientData.toString(), TextToSpeech.QUEUE_FLUSH, null);
